...
- 에러를 해결하기 위해 RootState로 interface화하여 해결하였으나,**<span style="color:#fff5b1">이는 잘못된 방식이었으며, <a href="https://redux-toolkit.js.org/usage/usage-with-typescript#getting-the-state-type">Redux Toolkit 공식문서</a>를 통해 코드를 수정**</span>하였습니다.
